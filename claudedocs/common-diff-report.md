...
Generated: 2025-11-24 17:18:06.248900
...
Path: `../blueprint/feature/common`

- `sign_in_with_email/test/unit/repository/sign_in_with_email_repository_test.dart`
- `sign_in_with_email/test/unit/usecase/sign_in_with_email_test.dart`
- `sign_in_with_email/test/unit/usecase/create_account_test.mocks.dart`
- `sign_in_with_email/test/unit/usecase/create_account_test.dart`
- `sign_in_with_email/test/unit/usecase/reset_password_test.dart`
- `sign_in_with_email/test/unit/usecase/reset_password_test.mocks.dart`
- `sign_in_with_email/test/unit/usecase/initiate_password_reset_test.dart`
- `sign_in_with_email/test/unit/usecase/initiate_password_reset_test.mocks.dart`
- `sign_in_with_email/test/unit/usecase/sign_in_with_email_test.mocks.dart`
- `sign_in_with_email/test/unit/usecase/confirm_email_test.mocks.dart`
- `sign_in_with_email/test/unit/usecase/confirm_email_test.dart`
- `sign_in_with_email/lib/sign_in_with_email.dart`
- `sign_in_with_email/lib/src/di/injector.dart`
- `sign_in_with_email/lib/src/di/injector.module.dart`
- `sign_in_with_email/lib/src/di/di.dart`
- `sign_in_with_email/lib/src/data/repository/sign_in_with_email_repository.dart`
- `sign_in_with_email/lib/src/data/repository/mixins/sign_in_with_email_serverpod_mixin.dart`
- `sign_in_with_email/lib/src/data/repository/mixins/mixins.dart`
- `sign_in_with_email/lib/src/data/repository/repository.dart`
- `sign_in_with_email/lib/src/data/data.dart`
- `sign_in_with_email/lib/src/domain/repository/i_sign_in_with_email_repository.dart`
- `sign_in_with_email/lib/src/domain/repository/repository.dart`
- `sign_in_with_email/lib/src/domain/entity/entity.dart`
- `sign_in_with_email/lib/src/domain/failure/failure.dart`
- `sign_in_with_email/lib/src/domain/failure/create_account_failure.dart`
- `sign_in_with_email/lib/src/domain/failure/initiate_password_reset_failure.dart`
- `sign_in_with_email/lib/src/domain/failure/sign_in_with_email_failure.dart`
- `sign_in_with_email/lib/src/domain/failure/create_account_request_failure.dart`
- `sign_in_with_email/lib/src/domain/failure/reset_password_failure.dart`
- `sign_in_with_email/lib/src/domain/failure/error_messages.dart`
- `sign_in_with_email/lib/src/domain/domain.dart`
- `sign_in_with_email/lib/src/domain/usecase/confirm_email_usecase.dart`
- `sign_in_with_email/lib/src/domain/usecase/reset_password_usecase.dart`
- `sign_in_with_email/lib/src/domain/usecase/sign_in_with_email_usecase.dart`
- `sign_in_with_email/lib/src/domain/usecase/create_account_usecase.dart`
- `sign_in_with_email/lib/src/domain/usecase/initiate_password_reset_usecase.dart`
- `sign_in_with_email/lib/src/domain/usecase/usecase.dart`
- `sign_in_with_email/lib/src/domain/exception/exception.dart`
- `sign_in_with_email/lib/src/domain/exception/sign_in_with_email_exception.dart`
- `sign_in_with_email/lib/src/presentation/page/page.dart`
- `sign_in_with_email/lib/src/presentation/page/sign_in_with_email_page.dart`
- `sign_in_with_email/lib/src/presentation/presentation.dart`
- `sign_in_with_email/lib/src/presentation/bloc/sign_in_with_email/sign_in_with_email_bloc.dart`
- `sign_in_with_email/lib/src/presentation/bloc/sign_in_with_email/sign_in_with_email_event.dart`
- `sign_in_with_email/lib/src/presentation/bloc/sign_in_with_email/sign_in_with_email_state.dart`
- `sign_in_with_email/lib/src/presentation/bloc/bloc.dart`
- `sign_in_with_email/.dart_tool/flutter_build/dart_plugin_registrant.dart`
- `sign_in_with_email/.dart_tool/build/entrypoint/build.dart`
- `settings/lib/src/data/repository/mixins/settings_serverpod_mixin.dart`
- `settings/.dart_tool/flutter_build/dart_plugin_registrant.dart`
- `extra_info/lib/src/data/repository/mixins/extra_info_serverpod_mixin.dart`
- `extra_info/.dart_tool/flutter_build/dart_plugin_registrant.dart`
- `splash/lib/src/di/injector.dart`
- `splash/lib/src/di/injector.module.dart`
- `splash/lib/src/di/di.dart`
- `splash/lib/src/data/repository/mixins/splash_serverpod_mixin.dart`
- `splash/.dart_tool/flutter_build/dart_plugin_registrant.dart`
- `auth/test/src/unit/usecase/get_user_usecase_test.dart`
- `auth/test/src/unit/usecase/get_my_info_usecase_test.dart`
- `auth/test/src/unit/usecase/update_user_name_usecase_test.dart`
- `auth/test/src/unit/usecase/sign_out_usecase_test.dart`
- `auth/test/src/unit/usecase/upload_profile_image_usecase_test.dart`
- `auth/test/src/presentation/widget/social_login_button_test.dart`
- `auth/test/src/presentation/bloc/auth_bloc_test.dart`
- `auth/lib/src/data/repository/mixins/auth_serverpod_mixin.dart`
- `auth/lib/src/data/cache/cache.dart`
- `auth/lib/src/data/cache/user_info_cache_repository.dart`
- `auth/lib/src/data/cache/user_info_cache_query.dart`
- `auth/lib/src/data/cache/user_info_network_repository.dart`
- `auth/lib/src/presentation/widgets/login_text_field.dart`
- `auth/lib/src/presentation/widgets/login_form_field.dart`
- `auth/.dart_tool/flutter_build/dart_plugin_registrant.dart`
- `life/lib/src/data/repository/mixins/user_serverpod_mixin.dart`
- `life/lib/src/data/cache/cache.dart`
- `life/lib/src/data/cache/user_network_repository.dart`
- `life/lib/src/data/cache/user_cache_repository.dart`
- `life/lib/src/data/cache/user_cache_query.dart`
- `life/.dart_tool/flutter_build/dart_plugin_registrant.dart`
- `withdraw/lib/src/data/repository/mixins/withdraw_serverpod_mixin.dart`
- `withdraw/.dart_tool/flutter_build/dart_plugin_registrant.dart`
...
- **Add to Project B**: 52 files missing
  - Consider: settings/lib/src/data/repository/mixins/settings_openapi_mixin.dart, extra_info/lib/src/data/repository/mixins/extra_info_openapi_mixin.dart, splash/lib/src/utils/platform_helper.dart...

- **Add to Project A**: 80 files missing
  - Consider: sign_in_with_email/test/unit/repository/sign_in_with_email_repository_test.dart, sign_in_with_email/test/unit/usecase/sign_in_with_email_test.dart, sign_in_with_email/test/unit/usecase/create_account_test.mocks.dart...
