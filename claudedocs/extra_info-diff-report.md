...
Generated: 2025-11-24 17:15:35.499845
...
Path: `../blueprint/feature/common/extra_info`

- `lib/src/data/repository/mixins/extra_info_serverpod_mixin.dart`
...
- **Add to Project B**: 1 files missing
  - Consider: lib/src/data/repository/mixins/extra_info_openapi_mixin.dart

- **Add to Project A**: 2 files missing
  - Consider: lib/src/data/repository/mixins/extra_info_serverpod_mixin.dart, .dart_tool/flutter_build/dart_plugin_registrant.dart
