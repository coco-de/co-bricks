...
const description = 'Mason bricks synchronization CLI tool';

/// {@template co_bricks_command_runner}
...
/// ```
/// {@endtemplate}
class CoBricksCommandRunner extends CompletionCommandRunner<int> {
  /// {@macro co_bricks_command_runner}
  CoBricksCommandRunner({Logger? logger, PubUpdater? pubUpdater})
